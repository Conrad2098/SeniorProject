...
$query = "SELECT * FROM MSUComment WHERE ID > '0';";
...
if(!$result){
    ...
    if(mysqli_num_rows($result) != 0){
        ...
        <tr style='font-size: 26px; color: #174074'>
            ...
            <th style='width: 15%; text-align: center;'>Document</th>
            <th style='width: 20%; text-align: center;'>Document ID</th>
        ...
        while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ...
            <td style='width: 15%;'>" . $row['Document'] . "</td>
            <td style='width: 20%;'>" . $row['DocumentID'] . "</td>
            <td style='width: 40%;' id='Comment" . $row['ID'] . "'>" . $row['Comment'] . "</td>
            <td style='width: 10%;'><button onclick='removeComment(" . $row['ID'] . ")'>Remove</button></td>
        </tr>";
        }
    }else{
        echo "<br><br><h2 style='text-align:center;'>No Comments<h2><br><br>";
